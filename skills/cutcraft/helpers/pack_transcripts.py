...
Usage:
    python helpers/pack_transcripts.py --work-dir <process_dir>
    python helpers/pack_transcripts.py --work-dir <process_dir> --silence-threshold 0.5
"""
...
def main() -> None:
    ...
    ap.add_argument("--work-dir", dest="edit_dir", type=Path, required=True,
                    help="CutCraft process directory (過程) containing transcripts/.")
    ap.add_argument(
        "--silence-threshold",
        type=float,
        default=0.5,
